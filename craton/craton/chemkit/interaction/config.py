...
CAPPED = ["ACE", "NME", "NMA"]
PROTONATED_AMINO_ACID = ["HID", "HIP", "HIE", "CYX", "CYM", "GLH"]

NON_STD_AMINO_ACID = ["SEC", "PYL"]
METAL_IONS = [
    "CA",
    "CO",
    "MG",
...
WEAK_HBOND_DIST_MAX = 3.8
WEAK_HBOND_DON_ANGLE_MIN = 135
CH_PI_DIST_MAX = 3  #  J. Med. Chem. 2021, 64, 16319−16327
CH_PI_CENTRAL_DIS = 1
CH_PI_PERIPHERAL_DIS = 2
...
anions = ["CL", "IOD", "BR"]
other = ["MO", "RE", "HO"]
UNSUPPORTED = anions + other + CAPPED
